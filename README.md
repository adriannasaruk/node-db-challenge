...
SQL, the Structured Query Language, is a language which is typically used to query the relational database. the relational database is the database software itself
- [ ] Why do tables need a `primary key`?
To have an identification and being able to connect to other tables.
- [ ] What is the name given to a table column that references the primary key on another table.
foreign key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
another table which references the id of both of them
